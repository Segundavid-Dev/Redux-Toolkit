  ...
  return (
    <div>
      <div className="mt-10 relative">
        ...
        />
        <button
          className="px-4 py-3 rounded-lg text-white bg-gradient-to-r from-purple-500 via-blue-500 to-blue-600  cursor-pointer text-[14px] absolute right-4 top-1/2 -translate-y-1/2 max-sm:static max-sm:w-full max-sm:mt-10"
          onClick={() => {
